import { Typography, Box, SelectChangeEvent, Button, FormControlLabel, Checkbox } from "@mui/material";
			...
			<Box sx={{ display: "flex", gap: 1.3, width: "100%", my: 2.5 }}>
				...
				<Box component="div" sx={{ width: "100%" }}>
					...
					<Box component="div" sx={{ ...styles.flexStack }}>
						...
						<Box sx={{ ...styles.flexStack }}>
							<ArrowLeftIconButton color={COLORS.GRANITE_GREY} onClick={() => console.log("decrement")} />
