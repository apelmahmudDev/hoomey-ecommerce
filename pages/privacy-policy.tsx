						...
						<List>
							...
							<BulletListItem>
								<Typography sx={{ color: COLORS.GRANITE_GREY }}>
									...
									to load the Site accurately for you, and to perform analytics on Site usage to
									optimize our Site.
								</Typography>
							</BulletListItem>
							...
							<BulletListItem>
								<Typography sx={{ color: COLORS.GRANITE_GREY }}>
									...
									Collected automatically when you access our Site using cookies, log files, web
						...
						<List>
							...
							<BulletListItem>
								<Typography sx={{ color: COLORS.GRANITE_GREY }}>
									...
									to provide products or services to you to fulfill our contract, to process your
									payment information, arrange for shipping, and provide you with invoices and/or
									order confirmations, communicate with you, screen our orders for potential risk or
									fraud, and when in line with the preferences you have shared with us, provide you
						...
						<List>
							<BulletListItem>
								<Typography sx={{ color: COLORS.GRANITE_GREY }}>
									...
									<Typography component="span" sx={{ fontStyle: "italic" }}>
										[MODIFICATIONS TO THE INFORMATION LISTED ABOVE OR ADDITIONAL INFORMATION AS
										NEEDED]
									</Typography>
								</Typography>
							</BulletListItem>
							...
							<Typography sx={{ color: COLORS.GRANITE_GREY }}>
								<Typography component="span" sx={{ fontStyle: "italic" }}>
									...
									DATA/LISTS] [INSERT FOLLOWING SECTION IF AGE RESTRICTION IS REQUIRED]
								</Typography>
							</Typography>
						</List>
