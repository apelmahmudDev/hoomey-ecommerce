							...
							<Grid container spacing={{ xs: 2, md: 5 }}>
								...
								<Grid item xs={12} md={9}>
									<Typography color="text.secondary">
										...
										your item to request a return. To be eligible for a return, your item must be in
										the same condition that you received it, unworn or unused, with tags, and in its
										original packaging. You&apos;ll also need the receipt or proof of purchase. If
										your return is accepted, we&apos;ll send you a return shipping label, as well as
							...
							<Grid container spacing={{ xs: 2, md: 5 }}>
								...
								<Grid item xs={12} md={9}>
									<Typography color="text.secondary">
										...
										touch if you have questions or concerns about your specific item. Unfortunately,
