						...
						<Grid container spacing={5}>
							...
							<Grid item xs={12} sm={9} md={10}>
								<Typography color="text.secondary" sx={{ lineHeight: "28px" }}>
									...
									dependability, customer service and affordable prices. <br /> We&apos;re working to
									turn our passion into a booming online store. We hope you enjoy our products as much
									as we enjoy offering them to you. If you have any questions or comments, please
